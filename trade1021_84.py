...
def trade_sell(ticker):
    ...
    sell_start = selltime.replace(hour=8, minute=50, second=00, microsecond=0)       #VC
    sell_end = selltime.replace(hour=8, minute=50, second=50, microsecond=0)         #VC
